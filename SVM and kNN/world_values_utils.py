...
def calculate_correlations(training_features,
    ...
    plot_hdi_vs_feature(training_features, training_labels, 'Protecting forests rivers and oceans', 'green', 'HDI vs. "Protecting forests rivers and oceans"')
    plot_hdi_vs_feature(training_features, training_labels, 'Better transport and roads', 'red', 'HDI vs. "Better transport and roads"')
    plot_hdi_vs_feature(training_features, training_labels, 'Access to clean water and sanitation', 'orange', 'HDI vs. "Access to clean water and sanitation"')
