...
class data_manager(object):
    ...
    def get_train_batch(self):
        ...
        while i < self.batch_size:
            images[i, :, :] = self.train_data[self.cursor]['features']
            labels[i, :] = self.train_data[self.cursor]['label']
    ...
    def get_validation_batch(self):
        ...
        i = 0
        while i < self.val_batch_size:
            images[i, :, :, :] = self.val_data[self.t_cursor]['features']
            labels[i, :] = self.val_data[self.t_cursor]['label']
            i += 1
            self.t_cursor += 1
